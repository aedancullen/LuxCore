...
#ifndef _SLG_SWINGENVIRONMENT_CAMERA_H
#define	_SLG_SWINGENVIRONMENT_CAMERA_H
...
class SwingEnvironmentCamera : public Camera {
public:
	SwingEnvironmentCamera(const luxrays::Point &o, const luxrays::Point &t,
		const luxrays::Vector &u, const float *sw = NULL);
	virtual ~SwingEnvironmentCamera() { }
...
#endif	/* _SLG_SWINGENVIRONMENT_CAMERA_H */
